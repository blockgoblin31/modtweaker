package com.blockgoblin31.ct_integrations.enderio.recipe.manager;
/*
...
import com.enderio.machines.common.integrations.crafttweaker.natives.SoulDataRegistry;
...
@ZenRegister
@Document("mods/ct_integrations/enderio/recipes/SoulBinder")
@ZenCodeType.Name("mods.ct_integrations.enderio.recipe.manager.SoulBinderRecipeManager")
public class SoulBinderRecipeManager implements IRecipeManager<SoulBindingRecipe> {
    ...
    */
    ...
    /*
    @ZenCodeType.Method
    public void addRecipe(String name, Item output, IIngredient input, int energy, int experience, SoulDataRegistry type, String soulData) {
        final ResourceLocation location = ResourceLocation.parse("crafttweaker:" + name);
