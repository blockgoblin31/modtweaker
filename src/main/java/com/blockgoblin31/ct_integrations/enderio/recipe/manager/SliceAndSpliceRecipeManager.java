...
@ZenRegister
@Document("mods/ct_integrations/enderio/recipes/SliceAndSpliceRecipeManager")
@ZenCodeType.Name("mods.ct_integrations.enderio.recipe.manager.SliceAndSpliceRecipeManager")
