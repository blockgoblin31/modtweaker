package com.blockgoblin31.ct_integrations.enderio.natives;
/*
...
@ZenRegister
@NativeTypeRegistration(value = SagMillingRecipe.BonusType.class, zenCodeName = "mods.ct_integrations.enderio.BonusType")
@Document("mods/ct_integrations/enderio/natives/BonusType")
