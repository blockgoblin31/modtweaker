package com.blockgoblin31.ct_integrations.ae2.recipe.manager;
...
@Document("mods/ct_integrations/ae2/recipes/In World Transformation")
@ZenCodeType.Name("mods.ct_integrations.ae2.recipe.manager.TransformRecipeManager")
